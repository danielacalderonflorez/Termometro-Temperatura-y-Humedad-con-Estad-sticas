...
void AgregarTemp(float t) {
    ...
    idx_buffer = (idx_buffer + 1) % 4;
    if(idx_buffer == 0) buffer_lleno = 1;
}

void CalcStats(void) {
    uint8_t n = buffer_lleno ? 4 : idx_buffer;
    uint8_t i;
    float suma = 0;
