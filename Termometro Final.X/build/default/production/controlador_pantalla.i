...
# 2 "<built-in>" 2
# 1 "controlador_pantalla.c" 2
# 1 "./controlador_pantalla.h" 1
...
# 7 "./controlador_pantalla.h" 2
# 22 "./controlador_pantalla.h"
...
# 2 "controlador_pantalla.c" 2

void Pantalla_ConfigurarPuerto(char a) {
    if(a & 1) PORTDbits.RD4 = 1; else PORTDbits.RD4 = 0;
    if(a & 2) PORTDbits.RD5 = 1; else PORTDbits.RD5 = 0;
    if(a & 4) PORTDbits.RD6 = 1; else PORTDbits.RD6 = 0;
    if(a & 8) PORTDbits.RD7 = 1; else PORTDbits.RD7 = 0;
}
